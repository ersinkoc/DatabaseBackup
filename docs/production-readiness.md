...
cancel/retry, restore preview plus guarded dry-run/live restore queueing, and
backup protection actions, and multi-instance control-plane operation is still
roadmap work.
MySQL/MariaDB
...
3. Extend E2E coverage into more retention policy edge cases and release
   verification drills.
4. Expand the WebUI from dashboard shell into live resource CRUD and richer
...
3. Expand the WebUI beyond the live overview dashboard into resource CRUD and
